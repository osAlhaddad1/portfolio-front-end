document.addEventListener('DOMContentLoaded', () => {
    ...
    const vec3 color1 = vec3(0.294,0.557,0.553); // Deep Blue
    const vec3 color2 = vec3(0.294,0.482,0.557); // Dark Red
    const vec3 color3 = vec3(0.294,0.482,0.557); // Bright Red
    const vec3 color4 = vec3(0.094,0.196,0.196); // Blue
