document.addEventListener('DOMContentLoaded', () => {
    ...
    const vec3 color1 = vec3(0.851,0.851,0.851); // Deep Blue
    const vec3 color2 =vec3(0.851,0.851,0.851); // Dark Red
    const vec3 color3 = vec3(0.447,0.506,0.459); // Bright Red
    const vec3 color4 = vec3(0.447,0.506,0.459); // Blue
