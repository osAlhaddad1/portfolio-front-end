document.addEventListener('DOMContentLoaded', () => {
    ...
    const vec3 color1 = vec3(0.961,0.804,0.694); // Deep Blue
    const vec3 color2 = vec3(0.961,0.804,0.694); // Dark Red
    const vec3 color3 = vec3(0.737,0.357,0.09); // Bright Red
    const vec3 color4 = vec3(0.737,0.357,0.09); // Blue
