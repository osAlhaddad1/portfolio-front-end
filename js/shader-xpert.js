document.addEventListener('DOMContentLoaded', () => {
    ...
    const vec3 color1 = vec3(0.941,0.918,0.863); // Deep Blue
    const vec3 color2 = vec3(0.918,0.882,0.804); // Dark Red
    const vec3 color3 = vec3(0.753,0.651,0.412); // Bright Red
    const vec3 color4 = vec3(0.753,0.651,0.412); // Blue
